...
> **Teknologi yang digunakan:** React JS, Tailwind CSS, Google Drive API, Google Sheets, QR Code generator.
...
1. Admin *upload* PDF baru ke folder Google Drive yang telah ditentukan.
2. Admin memperbarui data di Google Sheet (judul, kategori, ID file).
3. Document Portal secara otomatis menampilkan perubahan — tanpa perlu *deploy* ulang.
...
| &nbsp;&nbsp;Rawat | Proses pemutakhiran dokumen sederhana — *upload* PDF + perbarui sheet. |
